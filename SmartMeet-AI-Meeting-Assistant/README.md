...
## Business Purpose
An application that records meetings, highlights key points automatically, and provides suggestions to improve meeting management and productivity.
...
- Authentication & authorization software (example mentioned: Firebase Authentication)
...
- FR-010: Delete meeting (delete recording/transcript/summary; authorization checks)
